...
namespace GraphQLApi.Ui.Playground.Internal {
	...
	internal class PlaygroundPageModel {
		...
		public string Render() {
            ...
            using (var manifestResourceStream = assembly.GetManifestResourceStream("GraphQLApi.Ui.Playground.Internal.playground.cshtml")) {
